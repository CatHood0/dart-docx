      ...
      .addConditionalStyle(
        ConditionalTableStyle(
            ...
            TableStyleBuilder.table('GridTable5DarkFirstRow')
                .tableShading(color: Colors.black)
                .runColor(Colors.white)
                .bold()),
      )
      .addConditionalStyle(
        ConditionalTableStyle(
            ...
            TableStyleBuilder.table('GridTable5DarkBand1H')
                .tableShading(color: Colors.darkGrey)
                .runColor(Colors.white)),
      )
      .addConditionalStyle(
        ConditionalTableStyle(
            ...
            TableStyleBuilder.table('GridTable5DarkBand2H')
                .tableShading(color: Colors.grey)
                .runColor(Colors.white)),
      )
      .qFormat(true)
      .build();
...
//TODO: this does not work as expected. We need to test it and know exactly what does
